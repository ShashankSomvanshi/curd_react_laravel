  ...
  return (
    ...
    <Header/>
     <Hero preHeading={'Quality. Integrity. Value.'} 
        heading={'Services'} 
        text={'We excel at transforming vision into reality through oustanding craftsmanship and precise <br/> attentio detail.With years of experience and a dedicate to quality.'}/>
